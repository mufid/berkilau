...
Figure~\ref{fig:action_increases_uncertainty} visualizes how this happens for the action error model shown in figure~\ref{fig:encoder_err_model}.
...
Concretely, figure~\ref{fig:range_data} shows typical data from range sensors for some true value.
